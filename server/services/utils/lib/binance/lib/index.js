...
let api = function Binance(options = {}) {
    ...
    const futuresOrder = async (side, symbol, quantity, price = false, params = {}) => {
        ...
        if (!params.timeInForce && (params.type === "STOP" || params.type === "TAKE_PROFIT")) {
    ...
    return {
        ...
        //     });
        // },
        transferFuturesSubAccount: async (symbol, amount, fromEmail, params = {}) => {
            params.asset = symbol;
            params.amount = amount;
        ...
        transferSubAccount: async (symbol = "USDT", amount, fromEmail, toEmail, params = {}) => {
            params.asset = symbol;
            params.amount = amount;
            params.fromEmail = fromEmail;
